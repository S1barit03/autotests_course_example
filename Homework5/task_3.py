...
def everything_for_your_cat(cats_data):
    persons_dict = {}
    for cat_name, cat_age, name, surname in cats_data:
        fio = f'{name} {surname}'
        if fio in persons_dict:
            persons_dict.update({fio: persons_dict.get(fio) + [f'{cat_name}, {cat_age}']})
        else:
            persons_dict.update({fio: [f'{cat_name}, {cat_age}']})

    our_str = ''
    for fio, cats in persons_dict.items():
        cats_info = "; ".join(cats)
        our_str += f"{fio}: {cats_info}\n"
